  ...
  if (categories.length === 0) {
    return (
      <div className="px-4 py-10">
        <div className="rounded-[14px] border border-dashed border-border bg-card/50 px-4 py-16 text-center">
          <span className="text-5xl mb-4 block">🍽️</span>
          <h2 className="text-lg font-bold text-foreground mb-1">No categories yet</h2>
