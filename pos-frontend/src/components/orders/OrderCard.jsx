...
const OrderCard = ({ order, onManage }) => {
  return (
    <button
      ...
      className="mb-4 w-full rounded-lg bg-[#262626] p-4 text-left transition hover:bg-[#2d2d2d]"
    >
      <div className="flex items-center gap-5">
        <div className="rounded-lg bg-[#f6b100] p-3 text-xl font-bold">
      ...
      <div className="flex items-center justify-between mt-4">
        ...
        <div className="flex items-center gap-4">
          <p className="text-sm font-medium text-[#ababab]">Manage</p>
