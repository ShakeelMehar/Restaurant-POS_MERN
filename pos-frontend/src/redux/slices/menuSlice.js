...
// ⚡ Bolt: Memoize derived data to avoid unnecessary React re-renders
export const selectTotalDishCount = createSelector(
  [selectMenuCategories],
  (categories) => getTotalDishCount(categories)
);

// ⚡ Bolt: Memoize derived data to avoid unnecessary React re-renders caused by unstable references
