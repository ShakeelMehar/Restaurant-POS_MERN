...
const { register, login, getUserData, logout, getAllStaff, deleteStaff, updateStaffPassword } = require("../controllers/userController");
...
router.delete("/staff/:id", isVerifiedUser, checkRole(["admin"]), deleteStaff);
